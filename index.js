...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./xcoco")(XeonBotInc, m, chatUpdate, store)
        } catch (e) {
            console.log(e)
        }
    })
...
let buttonMessage = {
document: fs.readFileSync('./XcocoMedia/theme/cheems.xlsx'),
mimetype: docs,
...
app.get("/", (req, res) => {
    res.send("♻️ Xcoco-MD Working successfully!");
  });
  app.listen(port, () => console.log(`♻️ Xcoco-MD Server listening on port http://localhost:${port} 📟`));
  setTimeout(() => {
startXeonBotInc()
}, 3000);

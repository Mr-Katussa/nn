...
break
case 'video': //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
if(!text) throw `Example : ${prefix + command} How to make a whatsapp bot`
...
break
	    case 'ytmp3xx': case 'ytaudioxx': {
            ...
            break
case 'video': case 'ytvideo': //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
...
case 'keluar': case 'leave': {
            ...
            case 'ping': case 'botstatus': case 'statusbot': case 'p': {
                ...
                respon = `
*S P E E D* ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : ${runtime(process.uptime())}

*I N F O*
RAM: ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}`.trim()
                m.reply(respon)
            }
            break
            case 'setmenu': {
...
case 'up': {
                ...
                await XeonBotInc.sendText(m.chat, 'hi', lowq, botname, m, {quoted: fkontak})
            	}
            break
case 'handsomecheck':
...
case 'id':{
          ...
          break
case 'සුභ අලුත් අවුරුද්දක් වේවා':{
  if (!q) return m.reply(' එසේම වේවා🙂')
...
case 'alive': 
throw `*I AM ALIVE NOW* 😋`
break
			
case 'runtime': 
throw `*${runtime(process.uptime())}*`
break
